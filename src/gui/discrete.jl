...
function _make_discrete_gui()
    ...
    set_gtk_property!(discrete_auto_calc,:active,true)
...
function add_discrete_callbacks(w::discrete_widgets,handles::Tracker_Handles)
    ...
    signal_connect(discrete_distance_cb,w.space_button,"value-changed",Nothing,(),false,(handles,))
    signal_connect(discrete_points_cb,w.points_button,"value-changed",Nothing,(),false,(handles,))
    signal_connect(discrete_auto_cb,w.calc_button,"clicked",Nothing,(),false,(handles,))
    signal_connect(discrete_add_cb,w.add_button,"clicked",Nothing,(),false,(handles,))
    signal_connect(discrete_delete_cb,w.delete_button,"clicked",Nothing,(),false,(handles,))
...
function discrete_distance_cb(w::Ptr,user_data::Tuple{Tracker_Handles})
    ...
    num_dist=get_gtk_property(han.d_widgets.space_button,:value,Int)
...
function discrete_points_cb(w::Ptr,user_data::Tuple{Tracker_Handles})
    ...
    num_points=get_gtk_property(han.d_widgets.points_button,:value,Int)
    num_dist=get_gtk_property(han.d_widgets.space_button,:value,Int)
...
function discrete_auto_cb(w::Ptr, user_data::Tuple{Tracker_Handles})
    ...
    #han.discrete_auto_calc=get_gtk_property(han.d_widgets.calc_button,:active,Bool)
...
function discrete_add_cb(w::Ptr,user_data::Tuple{Tracker_Handles})
    ...
    if get_gtk_property(han.d_widgets.add_button,:active,Bool)
