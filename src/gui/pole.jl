...
function add_pole_callbacks(b::Gtk.GtkBuilder,handles::Tracker_Handles)
    ...
    signal_connect(pole_select_cb,b["select_pole_button"],"clicked",Nothing,(),false,(handles,))
    signal_connect(pole_auto_cb,b["find_pole_auto"],"clicked",Nothing,(),false,(handles,))
    signal_connect(pole_delete_cb,b["delete_pole_button"],"clicked",Nothing,(),false,(handles,))
...
function pole_select_cb(w::Ptr,user_data::Tuple{Tracker_Handles})
    ...
    if get_gtk_property(han.b["select_pole_button"],:active,Bool)
